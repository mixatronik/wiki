...
- Последняя протестированная работающая сборка - от 31.07.22. Сборка от 1.08.22 запускается, но в ней отсутствует eth0, как и во всех последующих. Причина выясняется.
...
- Запись на карту памяти не тестировал. 
